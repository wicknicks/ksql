...
public class StreamAggregate implements ExecutionStep {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(properties, source, aggValToFunctionMap, aggValToValColumnMap);
  }
  ...
  public String toString() {
    return "StreamAggregate{"
        ...
        + ", source=" + source
        + ", aggValToFunctionMap=" + aggValToFunctionMap
        + ", aggValToValColumnMap=" + aggValToValColumnMap
        + '}';
  }
}
