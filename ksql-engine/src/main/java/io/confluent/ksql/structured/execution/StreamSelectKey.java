...
public class StreamSelectKey implements ExecutionStep {
  ...
  public StreamSelectKey(
      ...
      @JsonProperty("updateRowKey") final boolean updateRowKey) {
    this.properties = Objects.requireNonNull(properties, "properties");
    this.source = Objects.requireNonNull(source, "source");
    this.updateRowKey = Objects.requireNonNull(updateRowKey, "updateRowKey");
  }

  public boolean getUpdateRowKey() {
    return updateRowKey;
  }
