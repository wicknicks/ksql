...
public class RecoveryTest {
  ...
  private class FakeCommandQueue implements ReplayableCommandQueue {
    ...
    public RestoreCommands getRestoreCommands() {
      ...
      commandLog.forEach(
          c -> restoreCommands.addCommand(c.getCommandId(), c.getCommand().get()));
  ...
  private class KsqlServer {
    ...
    KsqlServer(final List<QueuedCommand> commandLog) {
      ...
      this.commandRunner = new CommandRunner(statementExecutor, fakeCommandQueue);
    }
